...
" Last Updated: 2024年05月28日 19時19分32秒
...
hi DiffDelete guifg=#fea3c4 guibg=#a05b7d gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffDelete ctermfg=218 ctermbg=132 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi DiffDelete ctermfg=lightred ctermbg=darkmagenta cterm=NONE
